...
def set_model(name):
    ...
    ## Other ResNet
        ...
        try:
            ...
            from model.vision_multi_resnet import resnet_BP_m, resnet_SCPL_m
...
if __name__ == '__main__':
    ...
    from model.vision_multi import VGG_BP_m, VGG_SCPL_m
    from model.vision_multi import resnet18_BP_m, resnet18_SCPL_m
    ...
    if configs["save_path"] != None:
        ...
        if configs["profiler"] == True:
            from model.vision_multi_profiler import VGG_BP_m, VGG_SCPL_m
            from model.vision_multi_profiler import resnet18_BP_m, resnet18_SCPL_m
